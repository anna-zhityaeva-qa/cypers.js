describe('Покупка аватара', function () {                               // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get('input[type="email"]').type('anna.zhityaeva@yandex.ru');      // вводим логин
         cy.get('input[type="password"]').type('K@k0s123');    // вводим пароль
         ...
         cy.get('.k_input_name').type('Anna');                           // вводим имя владельца действия карты
